...
<label><input type="checkbox" id="workcheck" name="workcheck" value="신입">신입</label><br>
 <ul class="wrap_list_value column_two">
                ...
                <li><label class="frm_chkbox01" for="career-years02"><input type="checkbox" id="career-years" name="term" title="2년" value="2"><span>2년</span></label></li>
                <li><label class="frm_chkbox01" for="career-years03"><input type="checkbox" id="career-years" name="term" title="3년" value="3"><span>3년</span></label></li>
                <li><label class="frm_chkbox01" for="career-years04"><input type="checkbox" id="career-years" name="term"	title="4년" value="4"><span>4년</span></label></li>
                ...
                <li><label class="frm_chkbox01" for="career-years06"><input type="checkbox" id="career-years" name="term" title="6년" value="6"><span>6년</span></label></li>
                <li><label class="frm_chkbox01" for="career-years06"><input type="checkbox" id="career-years" name="term" title="7년" value="7"><span>7년</span></label></li>
                <li><label class="frm_chkbox01" for="career-years06"><input type="checkbox" id="career-years" name="term" title="8년" value="8"><span>8년</span></label></li>
                <li><label class="frm_chkbox01" for="career-years06"><input type="checkbox" id="career-years" name="term" title="9년" value="9"><span>9년</span></label></li>
