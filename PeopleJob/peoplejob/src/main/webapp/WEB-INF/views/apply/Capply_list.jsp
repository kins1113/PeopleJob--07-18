...
<%-- 		<div id="where">
	  ...
	  <!-- 반복문 시작  -->	  	
					...
					<td><a href="<c:url value='/apply/Check_pay.do?member_code=${vo.memberCode }&jobopening=${vo.jobopening }'/>"><input type="button" id="detail" class="btn btn-primary" name="detail" value="자세히보기"></a></td>
				</tr>
	    	</c:forEach>
	</c:if>
  <!--반복처리 끝  -->	
