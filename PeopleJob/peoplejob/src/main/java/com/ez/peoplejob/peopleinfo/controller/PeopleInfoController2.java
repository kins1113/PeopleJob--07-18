...
@Controller
@RequestMapping("/peopleinfo/where")
public class PeopleInfoController2 {
private Logger logger=LoggerFactory.getLogger(PeopleInfoController2.class);
...
private PeopleInfoService peopleinfoService;
	...
	public List<FirstOccupationVO> selectfirst(){
		...
		List<FirstOccupationVO> list=peopleinfoService.selectFirst();
	...
	public List<SecondOccupationVO> selectSecond(@RequestParam(defaultValue = "0")int firstCode){
		...
		List<SecondOccupationVO> list= peopleinfoService.selectSecond(firstCode);
		return list;
	}
	...
	public List<ThirdOccupationVO> selectThird(@RequestParam(defaultValue = "0")int secondCode){
		...
		List<ThirdOccupationVO> list= peopleinfoService.selectThird(secondCode);
		return list;
	}
	...
	public List<LocationVO> selectLocation(){
		...
		List<LocationVO> list = peopleinfoService.selectLocation();
	...
	public List<Map<String,Object>> selectLocation2(@RequestParam(defaultValue = "0")int sidoCode){
		...
		List<Map<String, Object>> list= peopleinfoService.selectLocation2(sidoCode);
	...
	public List<Map<String,Object>> selectBtype1(){
		...
		List<Map<String, Object>> list= peopleinfoService.selectBtype1();
	...
	public List<Map<String,Object>> selectBtype2(@RequestParam(defaultValue = "0")int btypeCode1){
		...
		List<Map<String, Object>> list= peopleinfoService.selectBtype2(btypeCode1);
	...
	public List<Map<String,Object>> selectBtype3(@RequestParam(defaultValue = "0")int btypeCode2){
		...
		List<Map<String, Object>> list= peopleinfoService.selectBtype3(btypeCode2);
